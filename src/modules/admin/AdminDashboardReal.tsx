...
useEffect(() => {
  ...
  const simulateRevenue = () => {
    setSimulatedRevenue((prev) => {
      ...
      const meiaQty = Math.floor(totalSoldNow * 0.10);
  ...
  const revenueChartData = liveTypes.map(type => ({
    name: type.name,
    revenue: type.phases.reduce(
      (acc, p) => acc + p.price * p.sold,
      0
    )
  }));
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
        ...
        {/* Receita */}
        <div className="bg-gradient-to-br from-purple-600/20 to-purple-900/20 backdrop-blur-md border border-purple-500/40 rounded-2xl p-6">
        ...
        {/* Ingressos */}
        <div className="bg-gradient-to-br from-purple-600/20 to-purple-900/20 backdrop-blur-md border border-purple-500/40 rounded-2xl p-6">
          <h3 className="text-gray-400 tracking-wider">
            Ingressos Vendidos
          </h3>
          <p className="text-3xl font-bold mt-3">
...
<div className="mt-10 relative">
  ...
  {/* Glow background */}
  <div className="absolute inset-0 bg-gradient-to-r from-purple-600/10 via-pink-500/10 to-purple-600/10 blur-3xl opacity-40" />
                    ...
                    <div key={phase.id} className="space-y-2">
                      ...
                      <div>
                        <div className="flex justify-between text-xs text-gray-400 mb-1">
                          <span>
                            {phase.sold.toLocaleString("pt-BR")} / {phase.limit.toLocaleString("pt-BR")} vendidos
                          </span>
                          <span>
                            {progress.toFixed(0)}%
                          </span>
                        ...
                        <div className="w-full h-3 bg-zinc-800 rounded-full overflow-hidden relative">
                          ...
                          <div
                            className="h-full bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 transition-all duration-700"
